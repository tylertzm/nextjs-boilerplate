...
export default function TimelinePage() {
  ...
  return (
    <div className="flow flex justify-center items-center min-h-screen  py-20">      
    <div className="container mx-auto px-4 md:px-6">
        <h1 className="mb-16 text-3xl font-light tracking-wider text-white-800 border-b border-neutral-200 pb-4 max-w-xs">
          時間の流れ
